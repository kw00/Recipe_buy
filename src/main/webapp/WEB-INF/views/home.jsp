...
<body>
		...
		<div class="container">
			<div class="banner-info">
				<h1 class="animated fadeInLeftBig" data-wow-duration="1000ms"
					data-wow-delay="300ms">
					Create your own recipes and share them <br> with people
					<span>Excepteur
				...
				<div class="banner-info1 animated wow fadeInDown"
					...
					<div class="more wow fadeInUp" data-wow-duration="1000ms"
						data-wow-delay="300ms">
						<a href="single.html" class="hvr-curl-bottom-right">Get Cooking</a>
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="col-md-3">
                ...
                <div class="controls pull-right hidden-xs" align="right">
                    <a class="left fa fa-chevron-left btn btn-default" href="#carousel-example-generic"
                        data-slide="prev"></a>
                    <a class="right fa fa-chevron-right btn btn-default" href="#carousel-example-generic"
                        data-slide="next"></a>
                </div>
            </div>
        </div>
	...
	<div class="procedure">
<table>
<h2 class="procedure-title" align="center">
Dinner, the Recipe buy</h2>
<br><br>
	<tr>
		<td>
			<img src="resources/bootstrap/images/service1.png">
		</td>
		
		<td rowspan="2">
			<img src="resources/bootstrap/images/service_logic.png">
		</td>
		
		<td rowspan="2">
			<img src="resources/bootstrap/images/service2.png">
		</td>
	</tr>
	
	<tr>
		<td>
			<img src="resources/bootstrap/images/service3.png">
		</td>
	</tr>
</table>
</div>
		...
		<div class="container">
			...
			<div class="banner-bottom-grids">
				...
				<div class="col-md-6 banner-bottom-grid-1 wow fadeInLeftBig"
					...
					<h1>We always ship <br>
					only fresh products</h1>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
			...
			<div class="footer-grids">
				<div class="col-md-3 footer-grid wow fadeInUp"
					...
					<div class="footer-grd-left">
						<img src="resources/bootstrap/images/6.jpg" class="img-responsive"
							alt=" " />
					</div>
					<div class="footer-grd-left">
