...
<body>
	...
	<br>
	<div class="container">
		<div class="recipe_header" align="center">
			<p>게시판 목록보기</p>
		</div>
		<br>
		<br>
		<div align="center">
			...
			<c:forEach items="${list}" var="lists" varStatus="status">
				...
				<a href="detailRecipe.recipe?rnum=${lists.rnum}"> <img
					src="<%=request.getContextPath()%>/resources/${lists.rimage}"
					width="300" height="300"> <font> ${lists.rwriter }
						${lists.rname} ${lists.rprice} </font>
				</a>
